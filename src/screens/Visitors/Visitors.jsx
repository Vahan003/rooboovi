...
import { getVisitorsThunk,postVisitorsThunk,putVisitorsThunk,deleteVisitorsThunk } from '../../thunks'
    ...
    return (
      ...
      <div className="inpSection">
           ...
           <input 
                  ...
                  className={this.state.checked && this.props.visitors.postVisitorsStatus  ? (this.state.updating? "greenborder": "") : "redborder"}
